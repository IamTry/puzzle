...
- (void)configCollectionView {
    ...
    [_collectionView registerClass:[TZGiASreviewCell class] forCellWithReuseIdentifier:@"TZGiASreviewCell"];
}
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (_tzImagePickerVc.allowPickingMultipleVideo && model.type == TZAssetModelMediaTypeVideo) {
        ...
        cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"TZGiASreviewCell" forIndexPath:indexPath];
    } else {
